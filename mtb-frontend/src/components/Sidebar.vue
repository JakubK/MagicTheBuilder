  ...
  <nav class="sidebar" :class="{ 'sidebar--active': active }">
    ...
    <div class="sidebar__content">
      <div class="sidebar__upper-content">
        <div class="sidebar__item" :class="{ 'sidebar__item--rolled': !active }">
          <Icon>
        ...
        <div class="sidebar__item" :class="{ 'sidebar__item--rolled': !active }">
          <Icon>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <defs>
                <clipPath id="clip0_259_505">
                  <rect width="24" height="24" fill="white" />
                </clipPath>
              </defs>
            </svg>
          </Icon>
          <span v-if="active">Github</span>
        </div>
        <div class="sidebar__item" :class="{ 'sidebar__item--rolled': !active }">
          <Icon>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <span v-if="active">Settings</span>
        </div>
        <div class="sidebar__item" :class="{ 'sidebar__item--rolled': !active }">
          <Icon>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
